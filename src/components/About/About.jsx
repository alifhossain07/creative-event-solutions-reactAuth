...
const About = () => {
  return (
    <div className="w-11/12 mx-auto my-12 p-8   rounded-lg bg-gradient-to-r from-blue-200 to-blue-50 ">
      ...
      <section className="mb-28">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-lg font-semibold text-gray-600 leading-relaxed mt-4">
