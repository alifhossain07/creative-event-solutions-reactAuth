...
const Testimonial = () => {
  return (
    <section className="py-12 w-11/12 mx-auto mt-20 mb-20 rounded-3xl bg-gradient-to-bl from-blue-500 via-cyan-200 to-sky-500">
      <div className="container mx-auto px-6">
        <h2 className="lg:text-3xl text-3xl font-bold text-center mb-12 text-gray-800">What Our Clients Say</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="relative bg-gradient-to-r from-cyan-50 via-sky-100 to-blue-100 p-8 rounded-lg shadow-xl transition-transform transform hover:scale-105 hover:shadow-2xl overflow-hidden">
